...
class TestLazyImports:
    ...
    def test_ragas_not_in_sys_modules_on_import(self):
        ...
        if "src.evaluation.evaluate_ragas" in sys.modules:
            del sys.modules["src.evaluation.evaluate_ragas"]

        import src.evaluation.evaluate_ragas  # noqa: F401
...
class TestBuildEvaluatorLLM:
    ...
    @patch("src.evaluation.evaluate_ragas.settings")
    def test_uses_gemini_when_google_api_key_set(self, mock_settings):
        ...
        with patch.dict(sys.modules, {
            ...
            from src.evaluation.evaluate_ragas import _build_evaluator_llm
...
class TestBuildEvaluatorEmbeddings:
    ...
    def test_returns_langchain_wrapper(self, mock_settings):
        ...
        with patch.dict(sys.modules, {
            ...
            from src.evaluation.evaluate_ragas import _build_evaluator_embeddings
...
class TestBuildGenerationClient:
    ...
    def test_returns_none_without_google_key(self, mock_settings):
        ...
        from src.evaluation.evaluate_ragas import _build_generation_client

...
class TestNBAGSQLToolInit:
    ...
    def test_init_default_params(self, mock_llm_class, mock_db_class):
        ...
        # Check database path
        expected_path = str(Path("database") / "nba_stats.db")
    ...
    @patch("src.tools.sql_tool.SQLDatabase")
    @patch("src.tools.sql_tool.ChatGoogleGenerativeAI")
    def test_init_custom_db_path(self, mock_llm_class, mock_db_class):
    ...
    @patch("src.tools.sql_tool.SQLDatabase")
    @patch("src.tools.sql_tool.ChatGoogleGenerativeAI")
    def test_init_custom_api_key(self, mock_llm_class, mock_db_class):
